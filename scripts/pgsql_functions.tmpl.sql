...
BEGIN
    ...
    INSERT INTO event_types ("type", count_events) VALUES ('audit.user.space_developer_add',100000),
                                                          ('audit.user.organization_user_add',10000),
                                                          ('audit.app.environment_variables.show',50000),
                                                          ('audit.service_binding.delete',50000),
                                                          ...
                                                          ('audit.user.organization_manager_remove',10000),
                                                          ...
                                                          ('audit.user.organization_billing_manager_remove',10000),
                                                          ...
                                                          ('audit.user.space_supporter_remove',5000),
                                                          ('audit.user.space_auditor_add',5000),
                                                          ('audit.user.space_supporter_add',5000),
                                                          ('audit.user.space_manager_add',5000),
                                                          ...
                                                          ('audit.user.organization_manager_add',5000),
